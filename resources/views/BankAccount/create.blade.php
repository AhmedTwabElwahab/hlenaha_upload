<x-app bodyClass="g-sidenav-show bg-gray-200" >
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="{{__('bank/index.create')}}" parent="{{__('bank/index.bank_Accounts')}}"></x-navbars.navs.auth>
        <!-- End Navbar -->
        <x-error></x-error>
                        ...
                        <form method='POST' action='{{ route('bank_account.store') }}' enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="number" name="iban" class="form-control border border-2 p-2" value='{{ old('iban') }}'>
                                    @error('iban')
                                        <p class='text-danger inputerror'>{{ $message }} </p>
                                    @enderror
                                </div>
