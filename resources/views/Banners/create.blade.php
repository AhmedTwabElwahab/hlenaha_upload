<x-app bodyClass="g-sidenav-show bg-gray-200" >
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage=" {{__('Banners/index.add_Banner')}}" parent="{{__('Banners/index.Banners')}}"></x-navbars.navs.auth>
        <!-- End Navbar -->
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="hlenaha_bk sign_bk border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize pe-3">{{__('Banners/index.add_Banner')}}</h6>
                            </div>
                        </div>
                                ...
                                <div class="card-header pb-0 p-3">
                                    <div class="row">
                                        <div class="col-md-8 d-flex align-items-center">
                                            <h6 class="mb-3">{{__('Banners/index.add_Banner')}}</h6>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="mb-3 col-md-12">
                                                ...
                                                <textarea class="form-control border border-2 p-2"
                                                          ...
                                                          rows="4" cols="50">{{ old('disc') }}</textarea>
                                                @error('disc')
                                                    <p class='text-danger inputerror'>{{ $message }} </p>
                                                @enderror
                                            </div>
